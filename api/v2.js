/**
 * Vercel serverless: POST /api/v2 (SMM / JAP-style API).
 * Without this file, /api/v2 is not a function route and the SPA static handler
 * can return 405 Method Not Allowed for POST.
 *
 * Set in Vercel → Environment Variables:
 *   BACKEND_URL  — Python API origin only, e.g. https://api.ytboost.io  (no trailing slash)
 * Optional:
 *   BACKEND_V2_PATH  — default /api/v2  (or /v2 if your Uvicorn only mounts /v2)
 */
